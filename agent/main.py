...
# ══════════════════════════════════════════════════
# RUTAS — alineadas con scraper.py v2.1
# ══════════════════════════════════════════════════
...
def run_pipeline(log: logging.Logger, max_pages: int = 20) -> dict:
    log.info("=" * 60)
    log.info("INICIANDO PIPELINE AGENTE ROI v2.1")
    ...
    # FASE 2: ESTADISTICAS MASTER CSV
...
def run_test(log: logging.Logger):
    log.info("=" * 50)
    log.info("MODO TEST - Verificando configuracion v2.1")
    log.info("=" * 50)
    errors = []
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Agente ROI - Tesis Kotska Pariona UNI 2026")
    ...
    parser.add_argument("--stats",  action="store_true", help="Ver estadisticas del Master CSV")
    ...
    if args.test:
        ...
        log.info("Comandos:")
        log.info("  python agent/main.py --test    # verificar")
        log.info("  python agent/main.py --batch   # ejecutar scraping")
        log.info("  python agent/main.py --stats   # estadisticas")
